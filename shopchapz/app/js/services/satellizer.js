...
// console.log('index.satellizer page load')
...
(function(window, angular, undefined) {
    ...
    // console.log('index.satellizer fn load')
        ...
        .constant('SatellizerConfig', {
            ...
            providers: {
                facebook: {
                    ...
                    name: 'facebook',
                    url: 'http://www.shopchapz.com:5090/auth/facebook',
                ...
                google: {
                    name: 'google',
                    url: 'http://localhost:3000/satellizer',
                ...
                linkedin: {
                    name: 'linkedin',
                    url: 'https://www.successhub.us:9000/auth/linkedin',
